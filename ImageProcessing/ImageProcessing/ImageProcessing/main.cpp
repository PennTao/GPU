...
int main(int argc, char* argv[])
{
	...
	negProgram = initShader("passthroughVS.glsl","negFS.glsl");
	gaussianProgram = initShader("passthroughVS.glsl","gaussianFS.glsl");
	grayscaleProgram = initShader("passthroughVS.glsl","grayscaleFS.glsl");
	edgeProgram = initShader("passthroughVS.glsl","edgeFS.glsl");
	toonProgram = initShader("passthroughVS.glsl","toonshadingFS.glsl");
	embossProgram = initShader("passthroughVS.glsl","embossFS.glsl");
